...
public final class BarcodeEOCVPipeline extends OpenCvPipeline {

    private static final BarcodeEOCVPipeline INSTANCE = new BarcodeEOCVPipeline();
    public static BarcodeEOCVPipeline getInstance() {return INSTANCE;}
    private BarcodeEOCVPipeline() {}
